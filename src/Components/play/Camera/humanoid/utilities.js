    ...
    predictions.forEach((prediction) => {
      ...
      if (detectionConfidence >= 0.999661922454834) {
        ...
        if (RightEye_Y > LeftEye_Y && RightEye_Y - LeftEye_Y > 35) {
          ...
          ctx.font = "25px Arial";
          ctx.scale(-1, 1);
          ctx.fillText(" TOP ", -400, 480);
          // ctx.fillText(" TOP ", 250, 480);
          ctx.fillStyle = "RED";
          ...
          ctx.font = "25px Arial";
          ctx.scale(-1, 1);
          ctx.fillText(" BOTTOM ", -400, 480);
          // ctx.fillText(" BOTTOM ", 250, 480);
          ctx.fillStyle = "RED";
        ...
        // ctx.fillText(" Unable to Recognition ", 100, 480);
        ctx.fillStyle = "Red";
      }
    });
  }
