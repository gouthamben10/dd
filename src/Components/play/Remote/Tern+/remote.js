...
import {
  ...
  joystickBGSrc,
  joystickSrc,
  playRemoreFollowmeSrc,
  playRemoreSmartmodeSrc,
  playRemoteDiscomodeSrc,
  playRemoteFlowLineSrc,
  playRemoteHornSrc,
  remoteButtonLightSrc,
  remoteButtonSpinSrc,
} from "../../../../source/source";
var setTime = 0;
        ...
        <div className="Remote-Mode">
          <div className="Follow-me-div">
            <div
              ...
              style={{ backgroundImage: `url(${playRemoreFollowmeSrc})` }}
            ></div>
          ...
          <div className="Smart-div">
            <div
              ...
              style={{ backgroundImage: `url(${playRemoreSmartmodeSrc})` }}
            ></div>
          ...
          <div className="disco-div">
            <div
              ...
              style={{ backgroundImage: `url(${playRemoteDiscomodeSrc})` }}
            ></div>
            <p className="Remote-mode-text">Disco Mode</p>
          </div>
          <div className="follow-line-div">
            <div
              className="follow-line click"
              onClick={this.followLineClick}
              style={{ backgroundImage: `url(${playRemoteFlowLineSrc})` }}
            ></div>
        ...
        <div className="Remote-unique">
          <div className="horn-div">
            <div
              ...
              style={{ backgroundImage: `url(${playRemoteHornSrc})` }}
            ></div>
            <p className="remote-unique-text ">Horn</p>
          </div>
          <div className="light-div">
            <div
              className="light click"
              onClick={this.lightClick}
              style={{ backgroundImage: `url(${remoteButtonLightSrc})` }}
            ></div>
            <p className="remote-unique-text ">Light</p>
          </div>
          <div className="spin-div">
            <div
              className="spin click"
              onClick={this.spinClick}
              style={{ backgroundImage: `url(${remoteButtonSpinSrc})` }}
            ></div>
            <p className="remote-unique-text ">Spin</p>
          </div>
        </div>
      </div>
    );
