...
class Actions extends Component {
    ...
    render() {
        var { value, PortConnections, state, onChange, hexChange, hexTypeCheck, current, startState, bottomPanelDeleteKey } = this.props
        if (current == "action") {
            current = "hardware"
        }
        ...
        return (
            <div>
                ...
                {current == "hardware" ? <Output value={value} PortConnections={PortConnections} state={state} onChange={onChange} hexTypeCheck={hexTypeCheck}
                    current={current} startState={startState} bottomPanelDeleteKey={bottomPanelDeleteKey} hexChange={hexChange} />
                    : (current == "wait" ? <WaitPanel value={value} PortConnections={PortConnections} state={state} onChange={onChange} hexTypeCheck={hexTypeCheck}
                        current={current} startState={startState} bottomPanelDeleteKey={bottomPanelDeleteKey} hexChange={hexChange} />
                        :
                        <VariableOutput value={value} PortConnections={PortConnections} state={state} onChange={onChange} hexTypeCheck={hexTypeCheck}
                            current={current} startState={startState} bottomPanelDeleteKey={bottomPanelDeleteKey} hexChange={hexChange} />
