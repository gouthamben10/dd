...
class IfPanel extends Component {
  ...
  hexTypeCheck = () => {
    ...
    this.props.hexTypeCheck("variable")
  }
    ...
    return (
      <div className="outertabDiv">
        <div className="tabDiv">
          <Link className="tabButton" onClick={() => this.props.hexChange("sensor")}><div>Sensor</div></Link>
          <Link className="tabActive" onClick={() => this.props.hexChange("variable")}><div> Variable  </div></Link>
