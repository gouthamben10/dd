...
const cellstyle = {borderRight: '0.125em solid ' + Colors.bordergrey, padding: '1.5em',textAlign: "left"  };
const flagcellstyle={borderRight: '0.125em solid ' + Colors.bordergrey,padding: '1.5em',paddingRight:"8%"}
const datacellstyle={borderRight: '0.125em solid ' + Colors.bordergrey,padding: '1.5em',paddingRight:"7%"}
      ...
      <table style={{
        ...
        <tbody>
          <tr className="animated slideInRight delay-0.5s">
            ...
            <td style={cellstyle} colSpan={2}>BICOUNTER 3</td>
            <td style={paddingNoRight}>
              <Checkbox checked={state.bts || false} onChange={(value) => this.onChange('bts', value)}/>
            </td>
            <td style={padding} colSpan={2}>BT Speech</td>
          </tr>
          ...
          <td>
            ...
            <td style={cellstyle} colSpan={2}>BIFLAG 3</td>
            <td style={paddingNoRight}>
              <Checkbox checked={state.bid1 || false} onChange={(value) => this.onChange('bid1', value)}/>
            </td>
            <td style={padding} colSpan={2}>BI DATA 1</td>
          </tr>
          <tr><td style={blank} colSpan={6}/></tr>
          <tr className="animated slideInRight delay-0.5s">
            <td>
            ...
            <td style={cellstyle} colSpan={2}>BI DATA 3</td>
            <td style={paddingNoRight}>
              <Checkbox checked={state.bmp3 || false} onChange={(value) => this.onChange('bmp3', value)}/>
            </td>
            <td style={{borderRight: '0.125em solid ' + Colors.bordergrey, padding: '1.5em',paddingRight:"8%"}}  colSpan={2}>Bluetooth MP3</td>
          </tr>
          <tr><td style={blank} colSpan={6}/></tr>
          <tr className="animated slideInLeft delay-0.5s">
          <td>
          ...
          <td style={cellstyle} colSpan={2}>BT Remote</td>
          <td style={padding}>
          <Checkbox checked={state.slider || false} onChange={(value) => this.onChange('slider', value)}/>

          </td>
     
          <td style={{borderRight: '0.125em solid ' + Colors.bordergrey, padding: '1.5em',paddingRight:"8%"}} colSpan={2}>BT slider</td>

          <td style={paddingNoRight}>
          <Checkbox checked={state.iot || false} onChange={(value) => this.onChange('iot', value)}/>

          </td>
          <td  style={{borderRight: '0.125em solid ' + Colors.bordergrey, padding: '1.5em',paddingRight:"12%"}}  colSpan={2}>IOT</td>
          </tr>         
        </tbody>
      </table>
    );
