  ...
  xmlChange: function () {
    ...
    for (let [key, value] of Object.entries(localObject)) {
      if (value) {
        ...
        console.log("localObject==========>>", value["componentType"]);
      }
    }
    ...
    console.log("SWAPNILLLLLLL", connectedPort);
    ...
    var category = () => {
      ...
      // console.log("LOGIC", Ports)
      // console.log("portArray", portArray, "devicesConnectedArray", devicesConnectedArray)

      // console.log("portInputArray", portInputArray, "devicesInputArray", devicesInputArray)
      //
      // console.log('FFFFFFFFF', Ports)
    ...
    console.log("####$$$", sensorsPort, sensorsDevices);
    logic_compare = () => {
      logic_compare = ` `;
