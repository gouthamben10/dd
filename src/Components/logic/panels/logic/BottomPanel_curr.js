...
class BottomPanel extends Component {
  ...
  render() {
    ...
    console.log("CurrentTABNEW", this.state.currenttab, current, state, value);
    if (current == "") {
      this.state.currenttab = current;
    }
    console.log("CurrentTAB2", this.state.currenttab, "2", current, state);

    var Panel = Panel1(this.state.currenttab ? this.state.currenttab : current);
    console.log(
      "CurrentTAB2",
      this.state.currenttab ? this.state.currenttab : current
    );
