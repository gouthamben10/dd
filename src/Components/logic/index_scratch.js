...
var Logic = React.createClass({
  ...
  componentWillMount: function () {
    const { program, end, offset, insertState, currentProgramGuide, active } =
      this.props.logic;
  ...
  removeCardConnections: function (index) {
    ...
    logicNew.cards[index].connections.map((connection, portIndex) => {
      logicNew.cards[connection.to].connections[connection.toPort].to =
        connection.to;
      logicNew.cards[connection.to].connections[connection.toPort].toPort =
        connection.toPort;
      connection.to = index;
  ...
  zoomNew: function (scale, clientX, clientY) {
    ...
    if (
      (logicNew.scale < 0.25 && scale < 1) ||
      (logicNew.scale > 2 && scale > 1)
    )
      return;
    zooming = true;
    clientX -= width * 0.2;
  ...
  */
  ...
  render: function () {
    ...
    if (this.state.currentLogicScreen == "hexa") {
            ...
            <div>
              <button
                style={{
                  ...
                  marginRight: "1%",
                  padding: 0,
                  border: "3px solid #F9CB2F",
                  backgroundColor: "#F9CB2F",
                  color: "grey",
                }}
                type="button"
                onClick={this.LogicButtonClicked}
              >
                <img
                  title="Hexa Screen"
                  style={{ height: "40px", width: "40px" }}
                  src="./images/hex progright.png"
                />
              </button>
              <button
                style={{
                ...
                type="button"
                onClick={this.LogicFlowButtonClicked}
              >
                <img
                  title="Logic Screen"
                  style={{ height: "40px", width: "40px" }}
                  src="./images/flowchart2right.png"
                />
              </button>
              <button
                style={{
                ...
                type="button"
                onClick={this.editorButtonClicked}
              >
                <img
                  title="Coding Screen coming soon"
                  style={{ height: "40px", width: "40px" }}
              ...
              <button
                ...
                type="button"
                onClick={this.pythonButtonClicked}
              >
                <img
                  title="Coding Screen coming soon"
                  style={{ height: "40px", width: "40px" }}
                  src="./images/pythonright.png"
                />
              </button>
              <button
                style={{
                ...
                type="button"
                onClick={this.ScratchButtonClicked}
              >
                <img
                  title="Coding Screen"
                  style={{ height: "40px", width: "40px" }}
                  src="./images/2-logic.png"
                />
              </button>
            </div>
          </div>
        ...
        <div>
              ...
              >
                ...
                >
                  ...
                  >
                    <div>
                      <p>
                        SET_AS_IN(PORT NAME); Setting a particular PORT as INPUT
                        digital. Example:- SET_AS_IN(A1);
                        <br />
                        SET_AS_OUT(PORT NAME); setting a particular PORT as
                        OUTPUT digital, Example:- SET_AS_OUT(B2);
                        <br />
                        WRITE_LOGIC(PORT NAME, LOGIC); writing a logic value to
                        a particular PORT, Example:- WRITE_LOGIC(A2, HIGH); OR
                        WRITE_LOGIC(A2, LOW);
                        <br />
                        READ_LOGIC(PORT NAME); Reading a LOGIC Value of the
                        particular PORT, Example:- int val = READ_LOGIC(A3);
                        <br />
                        WRITE_PWM(PORT NAME, VALUE); writing a PWM value of the
                        particular PORT, Example:- WRITE_PWM(A2, 255);
                        <br />
                        PULSE_OUT(PORT NAME, TIME, LOGIC); Writing a PULSE
                        signal to a PARTICULAR PORT, Example:- PULSE_OUT(B1, 3,
                        HIGH);
                        <br />
                      </p>
                      <br />
                      <p>
                        <h3> MOTORS</h3>
                        SERVO(PORT NAME, DEGREE); Writing a Degree value to the
                        PORT, Example:- SERVO(A2, 120);
                        <br />
                        MOTORx(DIRECTION, SPEED); Making a MOTOR rotate in the
                        particular direction and speed on the MOTOR PORTS, here
                        “x” means the particular MOTOR PORT number, Example:-
                        MOTOR1(CLOCKWISE, 20); OR MOTOR2(ANTICLOCKWISE, 20);
                        <br />
                      </p>
                      <br />
                      <p>
                        ...
                        <br />
                        SELECT_ADC_PORT(PORT NAME); Selecting the ADC channel
                        for analog input, Example:- SELECT_ADC_PORT(A1);
                        <br />
                        READ_ADC(PORT NAME); reading a ADC value of the
                        particular PORT, Example:- int value= READ_ADC(A2);
                        <br />
                        SET_RESOLUTION(BIT SIZE); setting the bit size of the
                        ADC resultant, Example:- SET_RESOLUTION(10);
                        <br />
                      </p>
                      <br />
                    </div>
          ...
          <div onWheel={this.wheel}>
            <Hammer
              ...
              onPanStart={this.panStart}
              onPanEnd={this.panEnd}
              onTap={this.handleBottomPanelClick}
            >
              <div className="draw">
                <svg
                  height="100%"
                  ...
                  >
                    <div>
                      <p>
                        ...
                        <br />
                        <br />
                        digital.write(Port,Logic)
                        <br />
                        <br />
                        Pwm.write(Port,value)
                        <br />
                        <br />
                        Motor.write(Port,value)
                        <br />
                        <br />
                        Servo.write(Port,degree)
                        <br />
                        <br />
                        MP3.write(value)
                        <br />
                        <br />
                        Dotmatrix.write(Port,character)
                        <br />
                        <br />
                        digital.read(Port)
                        <br />
                        ...
                        <br />
                        <br />
                        Ultrasonic.read(Port)
                        <br />
                        <br />
                        Supersensor.read(Sensor)
                        <br />
                        <br />
                        RFID.read(Port)
                        <br />
      ...
      editorRendered = true;
      var index = this.state.currentNodeIndex;
      if (logicNew.cards) current = logicNew.cards[index].type;
      var currentState = {};
      ...
      if (
        current === "blank" ||
        current === "" ||
        this.state.currentNode.type === undefined
      )
        bottomPanel = "none";
      return (
        <div>
          ...
          <div className="pure-g" style={{ height: "100%", width: "100%" }}>
            ...
            <div className="pure-u-5-6">
              ...
              >
                ...
                <DropspaceNew
                  ...
                  makeCurrentNode={this.setCurrentNode}
            ...
            <CustomDragLayerNew
              cards={logicNew.cards}
              height={height}
              width={width}
              sidebarWidth={(width * 1) / 6}
              logicNew={logicNew}
...
module.exports = DragDropContext(TouchBackend({ enableMouseEvents: true }))(
  Logic
);
